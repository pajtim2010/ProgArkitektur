...
<head>
    ...
    <title>Project ProgvareArkitektur</title>
</head>
<body id="loginf">

<h1 id="banner">Create New Person</h1>
	...
	<table>
		...
		<tr>
                        ...
                        <form:select path="courses1">
                            <form:option value="infoArkitektur">Informasjonsarkitektur</form:option>
                            <form:option value="matte">Matte</form:option>
                            <form:option value="programmering">Programmering</form:option>
                        </form:select>
                        </td>
